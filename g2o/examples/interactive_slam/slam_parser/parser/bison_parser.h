...
/**
 ** \file bison_parser.h
 ** Define the slam_parser::parser class.
 */
...
#ifndef YY_SLAM_PARSER_BISON_PARSER_H_INCLUDED
#define YY_SLAM_PARSER_BISON_PARSER_H_INCLUDED
...
/* Debug traces.  */
#ifndef SLAM_PARSERDEBUG
#if defined YYDEBUG
#if YYDEBUG
#define SLAM_PARSERDEBUG 1
#else
#define SLAM_PARSERDEBUG 0
#endif
#else /* ! defined YYDEBUG */
#define SLAM_PARSERDEBUG 0
#endif /* ! defined YYDEBUG */
#endif /* ! defined SLAM_PARSERDEBUG */
...
class Parser {
 public:
#ifdef SLAM_PARSERSTYPE
#ifdef __GNUC__
#pragma GCC message \
    "bison: do not #define SLAM_PARSERSTYPE in C++, use %define api.value.type"
#endif
  typedef SLAM_PARSERSTYPE value_type;
#else
...
#line 216 "bison_parser.h"
  ...
  struct token {
    enum token_kind_type {
      SLAM_PARSEREMPTY = -2,
      END = 0,                 // "end of file"
      SLAM_PARSERerror = 256,  // error
      SLAM_PARSERUNDEF = 257,  // "invalid token"
      EOL = 258,               // "end of line"
      INTEGER = 259,           // "integer"
      DOUBLE = 260,            // "double"
      STRING = 261,            // "string"
...
#endif  // !YY_SLAM_PARSER_BISON_PARSER_H_INCLUDED
